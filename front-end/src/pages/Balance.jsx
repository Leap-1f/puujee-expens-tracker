  ...
  return (
    <div className="w-[100vw] h-[100vh] bg-white ">
      <div className="flex flex-col justify-center items-center gap-[100px]">
        ...
        <div className="w-[25vw] h-[40vh]  gap-[10px] p-[20px] flex flex-col items-center">
          <img className="w-[150px] " src="cash.svg" alt="" />
          <p className="text-2xl text-black font-bold">
            Set up your cash Balance
          </p>
          <div>
            <label className="input input-bordered flex items-center gap-2 h-[50px] w-[100%] border-gray-500 bg-gray-200 border text-black">
            ...
            <Link
              href={"/Finish"}
              className="btn my-[60px] h-[50px] rounded-3xl  w-[100%] text-white bg-blue-500 text-xl "
            >
              Confirm
            </Link>
          </div>
