    ...
    <Fragment>
      <div className="relative flex flex-col items-center  rounded-xl w-[350px] h-[60px]">
        <button
          ...
          className="bg-gray-100 p-4 w-full rounded-xl h-[60px] flex justify-between text-md    active:border-blue-500 active:text-blue-500 duration-300 avtive:text-blue-500"
        >
        ...
        {isOpen && (
          <div className="bg-gray-100 shadow-2xl absolute top-[65px] flex flex-col items-start rounded-lg p-2 w-full ">
            <div className="flex w-full flex-col cursor-pointer overflow-x-hidden overflow-y-auto snap-y">
              ...
              <div className="flex w-[350px] items-center gap-[25px] h-[50px]  border-black hover:underline border-l-transparent  hover:border-l-blue-500 border-l-4 tracking-wider  ">
